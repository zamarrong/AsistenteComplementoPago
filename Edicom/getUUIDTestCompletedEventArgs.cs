...
// Type: AsistenteComplementoPago.Edicom.getUUIDTestCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getUUIDTestCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getUUIDTestCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
