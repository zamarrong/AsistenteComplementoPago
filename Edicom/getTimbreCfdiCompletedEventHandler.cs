...
// Type: AsistenteComplementoPago.Edicom.getTimbreCfdiCompletedEventHandler
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public delegate void getTimbreCfdiCompletedEventHandler(
    object sender,
    getTimbreCfdiCompletedEventArgs e);
}
