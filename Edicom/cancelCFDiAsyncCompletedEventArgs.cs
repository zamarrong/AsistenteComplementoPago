...
// Type: AsistenteComplementoPago.Edicom.cancelCFDiAsyncCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class cancelCFDiAsyncCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal cancelCFDiAsyncCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
