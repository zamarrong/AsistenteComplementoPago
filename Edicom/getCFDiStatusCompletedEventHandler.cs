...
// Type: AsistenteComplementoPago.Edicom.getCFDiStatusCompletedEventHandler
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public delegate void getCFDiStatusCompletedEventHandler(
    object sender,
    getCFDiStatusCompletedEventArgs e);
}
