...
// Type: AsistenteComplementoPago.Edicom.getTimbreCfdiRetencionesTestCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getTimbreCfdiRetencionesTestCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getTimbreCfdiRetencionesTestCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
