...
// Type: AsistenteComplementoPago.Edicom.getCfdiCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getCfdiCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getCfdiCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
