...
// Type: AsistenteComplementoPago.Edicom.cancelaCFDiRetencionesSignedCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class cancelaCFDiRetencionesSignedCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal cancelaCFDiRetencionesSignedCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
