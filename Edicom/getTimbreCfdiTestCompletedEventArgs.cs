...
// Type: AsistenteComplementoPago.Edicom.getTimbreCfdiTestCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getTimbreCfdiTestCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getTimbreCfdiTestCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
