...
// Type: AsistenteComplementoPago.Edicom.getCfdiTestCompletedEventHandler
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public delegate void getCfdiTestCompletedEventHandler(
    object sender,
    getCfdiTestCompletedEventArgs e);
}
