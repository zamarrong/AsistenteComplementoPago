...
// Type: AsistenteComplementoPago.Edicom.getCFDiStatusCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getCFDiStatusCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getCFDiStatusCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
