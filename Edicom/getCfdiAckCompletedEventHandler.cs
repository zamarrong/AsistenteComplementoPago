...
// Type: AsistenteComplementoPago.Edicom.getCfdiAckCompletedEventHandler
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public delegate void getCfdiAckCompletedEventHandler(
    object sender,
    getCfdiAckCompletedEventArgs e);
}
