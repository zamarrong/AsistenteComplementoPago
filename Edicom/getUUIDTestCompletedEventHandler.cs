...
// Type: AsistenteComplementoPago.Edicom.getUUIDTestCompletedEventHandler
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public delegate void getUUIDTestCompletedEventHandler(
    object sender,
    getUUIDTestCompletedEventArgs e);
}
