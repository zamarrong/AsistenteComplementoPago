...
// Type: AsistenteComplementoPago.Edicom.cancelaCFDiRetencionesCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class cancelaCFDiRetencionesCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal cancelaCFDiRetencionesCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
