...
// Type: AsistenteComplementoPago.Edicom.getCfdiTestCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getCfdiTestCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getCfdiTestCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
