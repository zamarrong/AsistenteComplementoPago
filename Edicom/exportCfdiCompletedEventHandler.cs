...
// Type: AsistenteComplementoPago.Edicom.exportCfdiCompletedEventHandler
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public delegate void exportCfdiCompletedEventHandler(
    object sender,
    exportCfdiCompletedEventArgs e);
}
