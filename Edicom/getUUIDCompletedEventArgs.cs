...
// Type: AsistenteComplementoPago.Edicom.getUUIDCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getUUIDCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getUUIDCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
