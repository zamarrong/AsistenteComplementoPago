...
// Type: AsistenteComplementoPago.Edicom.cancelaCFDiCompletedEventHandler
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public delegate void cancelaCFDiCompletedEventHandler(
    object sender,
    cancelaCFDiCompletedEventArgs e);
}
