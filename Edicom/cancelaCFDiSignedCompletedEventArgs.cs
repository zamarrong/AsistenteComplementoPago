...
// Type: AsistenteComplementoPago.Edicom.cancelaCFDiSignedCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class cancelaCFDiSignedCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal cancelaCFDiSignedCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
