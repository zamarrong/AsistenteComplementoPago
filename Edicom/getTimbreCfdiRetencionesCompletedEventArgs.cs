...
// Type: AsistenteComplementoPago.Edicom.getTimbreCfdiRetencionesCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getTimbreCfdiRetencionesCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getTimbreCfdiRetencionesCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
