...
// Type: AsistenteComplementoPago.Edicom.getCfdiFromUUIDCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class getCfdiFromUUIDCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal getCfdiFromUUIDCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
