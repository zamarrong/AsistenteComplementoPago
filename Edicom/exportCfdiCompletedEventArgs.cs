...
// Type: AsistenteComplementoPago.Edicom.exportCfdiCompletedEventArgs
...
namespace AsistenteComplementoPago.Edicom
{
  ...
  public class exportCfdiCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal exportCfdiCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
